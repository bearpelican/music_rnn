...
def make_h5_command(infile, outdir):
    return make_h5(infile, outdir)
...
def train_command(input_h5, checkpoint_dir):
    return train(input_h5, checkpoint_dir)
...
def sample(checkpoint, temperature, start_text_file):
    sample(checkpoint, temperature, start_text_file)
